...
// TODO do przerobienia, żeby w tym miejscu wybierać listę sklepów, a tworzyć z głównego menu
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var shopListId = ""
        if(intent.hasExtra(Constants.SHOPLIST_ID)){
            shopListId = intent.getStringExtra(Constants.SHOPLIST_ID).toString()
        }
        setupActionBar()

//        showProgressDialog(resources.getString(R.string.please_wait))
//        TODO pobranie listy sklepów
//        FirestoreClass().getAssignedMembersListDetails(this, mShop.assignedTo)
    }
